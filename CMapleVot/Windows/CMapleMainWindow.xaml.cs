...
namespace CMapleVot
{
    ...
    public partial class CMapleMainWindow : Window
    {
        ...
        {
            this.Top = CMapleStaticVariable.MAX_WINDOW_HEIGHT / 2 - this.Height / 2;
            this.Left = CMapleStaticVariable.MAX_WINDOW_WIDTH / 2 - this.Width / 2;
        }
        #endregion
        ...
        private void Window_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            try
            {
                ...
                if (maple_cThread != null)
                    maple_cThread.Abort();

                if (detect_pThread != null)
        ...
        private void Button_Info_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                windowInfo = new CMapleInfoWindow();
                windowInfo.Show();
            }
        }
        ...
        public void OnHotKeyPressed(Key hotKey)
        {
            if (hotKey == Key.F10)
